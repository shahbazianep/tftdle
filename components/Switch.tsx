export default function Switch({
	...
	return (
		...
		>
			...
			{
				<span
					className={`select-none absolute font-[Beatrice-Medium] top-1/2 -translate-y-1/2 text-[10px] text-[#AD3F3F] left-4 duration-300 transition-opacity ease-in-out ${
			...
			{
				<span
					className={`select-none absolute font-[Beatrice-Medium] top-1/2 -translate-y-1/2 text-[10px] text-[#6A7947] right-2 duration-300 transition-opacity ease-in-out ${
						checked ? "opacity-100 delay-120" : "opacity-0"
					}`}
				>
					NORMAL
