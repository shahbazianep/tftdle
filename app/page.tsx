    ...
    return (
        <>
            ...
            {champs && filteredChamps && answer && (
                <div
                    className={`flex flex-col items-center justify-center min-h-screen w-full text-black ${
                    ...
                    {finished && (
                        <div className="absolute top-0 left-0 w-screen h-screen bg-black/50 flex flex-row items-center justify-center text-center backdrop-blur-md">
                            <div className="left-1/2 top-1/2 bg-red-400 flex items-center justify-center py-24 px-24">
                                Congratulations! You took {guesses.length}{" "}
                                guesses to guess today&apos;s TFTdle champion:{" "}
                                {answer.name}
                            </div>
                        </div>
                    )}
